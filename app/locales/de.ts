...
const de: PartialLocaleType = {
  ...
  Error: {
    ...
    \\ 1️⃣ Wenn du deine eigenen OpenAI-Ressourcen verwenden möchtest, klicke [hier](/#/settings), um die Einstellungen zu ändern ⚙️`
      : `😆 Das Gespräch hatte einige Probleme, keine Sorge:
    \ 1️⃣ klicke [hier](/#/auth), um den Zugriffsschlüssel einzugeben 🔑    
 `,
  },
  Auth: {
  ...
  Home: {
    ...
    Subtitle: "Lassen Sie jeden die Freude an KI genießen.",
    Subtitle1: "Priorisieren Sie die Verwendung des gpt-4o-mini Modells.",
  },
  Settings: {
    Title: "Einstellungen",
