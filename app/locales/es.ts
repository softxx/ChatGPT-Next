...
const es: PartialLocaleType = {
  ...
  Error: {
    ...
    \\ 1️⃣ Si deseas usar tus propios recursos de OpenAI, haz clic [aquí](/#/settings) para modificar la configuración ⚙️`
      : `😆 La conversación encontró algunos problemas, no te preocupes:
    \ 1️⃣ haz clic [aquí](/#/auth) para ingresar la clave de acceso 🔑
 ...
 `,
  ...
  Home: {
    ...
    Revert: "Deshacer",
    Subtitle: "Permite que todos disfruten del placer de la IA.",
    Subtitle1: "Prioriza el uso del modelo gpt-4o-mini.",
  },
  Settings: {
    Title: "Configuración",
