...
const fr: PartialLocaleType = {
  ...
  Error: {
    ...
    \\ 1️⃣ Si vous souhaitez utiliser vos propres ressources OpenAI, cliquez [ici](/#/settings) pour modifier les paramètres ⚙️`
      : `😆 La conversation a rencontré quelques problèmes, pas de panique :
    \ 1️⃣ cliquez [ici](/#/auth) pour entrer la clé d'accès 🔑
 ...
 `,
  ...
  Home: {
    ...
    Revert: "Annuler",
    Subtitle: "Permettez à tout le monde de profiter du plaisir de l'IA.",
    Subtitle1: "Veuillez privilégier l'utilisation du modèle gpt-4o-mini.",
  },
  Settings: {
    Title: "Paramètres",
